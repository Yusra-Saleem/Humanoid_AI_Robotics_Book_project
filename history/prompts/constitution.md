...
Added Sections:
  - Updated PROJECT TITLE and OUTPUT REQUIREMENTS
  - Detailed Course Structure (Quarter Overview, Why Physical AI Matters, Learning Outcomes, Weekly Breakdown, Assessments, Hardware Requirements)
Removed Sections:
  - None
...
**Crucially, assume Docusaur is already installed and initialized in a local folder named 'my-ai-book'.**

**PROJECT TITLE:** Hackathon: Create a Textbook for Teaching Physical Al & Humanoid Robotics Course

**OUTPUT REQUIREMENTS:**
1. **Target Directory:** All book content files (`.mdx`) must be generated inside the existing Docusaurus `docs/` folder, using a **nested folder structure** (e.g., `my-ai-book/docs/Module1-ROS2/...`).
2. Poora output Docusaurus-compatible Markdown (.mdx) format mein hona chahiye, jismein zaroori frontmatter bhi ho.
3. Structure mein 5 main documents honge, organized in **nested folders** (e.g., `docs/Module1-ROS2/ros2.mdx`).
4. Content, Modules, aur Weekly Breakdown ki details bilkul waisi hi honi chahiye jaisi neeche provide ki gayi hain.
...
**FINAL RULE:** Generate the complete Docusaurus project structure and content based ONLY on this Constitution, targeting the existing `my-ai-book/docs/` folder.
**FINAL RULE:** Generate the complete Docusaurus project structure and content based ONLY on this Constitution, targeting the existing `my-ai-book/docs/` folder.
## **The Course Details**
