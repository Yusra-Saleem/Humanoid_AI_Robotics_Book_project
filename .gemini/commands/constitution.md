...
Templates requiring updates:
  ...
  - ⚠ pending .specify/templates/adr-template.md (Consider adding a section for 'Principles Adherence' in ADRs)
Follow-up TODOs:
  - None
-->
# **Physical AI & Humanoid Robotics - THE DEFINITIVE COURSE GUIDE**
...
Aap ek AI-Driven Textbook Author hain. Aapka primary aur sole goal ek complete, developer-ready Docusaurus Textbook project generate karna hai.

**Aapka Pura Gyan aur Structure yahan diya gaya hai. Aap is structure, topic, aur detail level se bilkul bhatkenge nahi.**

**PROJECT TITLE:** Hackathon: Create a Textbook for Teaching Physical Al & Humanoid Robotics Course

**OUTPUT REQUIREMENTS:**
1. Poora output **Docusaurus-compatible Markdown (.mdx)** format mein hona chahiye, jismein zaroori frontmatter bhi ho.
2. Structure mein 5 main documents honge: **Introduction (Weeks 1-2 & Hardware)**, aur phir **Module 1** se **Module 4** tak ke chapters.
3. Content, Modules, aur Weekly Breakdown ki details bilkul waisi hi honi chahiye jaisi neeche provide ki gayi hain.
...
**Principle:** All AI systems developed within this project MUST be designed to interact with, perceive, and comprehend the physical world. This includes understanding physical laws, spatial relationships, and real-world dynamics. 

**Rationale:** The core theme is bridging the gap between digital intelligence and physical embodiment, enabling AI to operate effectively in real-world environments.

### **2. Digital-Physical Integration**

**Principle:** The project MUST prioritize the seamless integration of advanced AI capabilities (e.g., LLMs, perception models) with robotic hardware and simulation platforms (ROS 2, NVIDIA Isaac). 

**Rationale:** This principle ensures that the AI's cognitive strengths are effectively translated into physical actions and control of robotic systems.

### **3. Developer-Ready Educational Content**

**Principle:** All generated textbooks and course materials MUST be of high quality, accurate, practical, and readily usable by developers and students. Content should be structured for clarity and ease of learning, adhering to Docusaurus standards. 

**Rationale:** The project aims to create accessible and effective learning resources that empower individuals to enter the field of Physical AI and Humanoid Robotics.

### **4. Collaborative Ecosystem**

**Principle:** The project fosters an open and collaborative environment for AI education and content creation. Sharing of knowledge, tools, and best practices is encouraged to accelerate innovation and learning.

**Rationale:** Building a community around AI education leads to more robust, diverse, and impactful educational offerings.

## Governance

### **Amendment Procedure**

Amendments to this constitution require a formal proposal, a minimum two-week review period for community feedback, and consensus among core project maintainers. Significant changes may require a broader community vote.

### **Versioning Policy**

This constitution follows semantic versioning (MAJOR.MINOR.PATCH).
*   **MAJOR:** Incompatible changes to core principles or governance structure.
*   **MINOR:** Addition of new principles, sections, or significant expansion of existing guidance.
*   **PATCH:** Clarifications, wording adjustments, typo fixes, and minor updates to governance details.

### **Compliance Review**

Adherence to these principles will be reviewed regularly (at least annually) or upon significant project milestones. Reviews will assess alignment with evolving AI and robotics standards and best practices.
